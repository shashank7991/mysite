...
class TripsView(APIView):
    # get all trips and pass it as a json object
    def get(self, request, *args, **kwargs):
    ...
    def post(self, request, *args, **kwargs):
        data = request.data
        try:
            #retrieve all trips based on parameteres passed from ui
...
class EventsView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        data = request.data
        try:
            #related events based on matching conditions
